...
class MainMenu
{
    ...
    void drawBox(std::string text, float position, float highLight); //draw button box - takes string (button text),
                                                                     //the position (for offset from other buttons),
                                                                     //and highlight, which is added to glColor to "highlight"
